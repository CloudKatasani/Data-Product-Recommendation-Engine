...
FORBIDDEN_OBJECTS = (
    "RAW_",
    # The decision and weight record: who decided what, and under which vector.
    "REVIEW_DECISION", "SCORE_WEIGHT", "WEIGHT_APPROVAL", "CONFIG_CHANGE",
    # The governance ledgers, which carry identities and rationales.
    "GATE_WAIVER", "CONFLICT_DECISION", "METRIC_NAME_DECISION", "REPORT_OVERRIDE",
    "CANDIDATE_CONSUMER_CONFIRMATION", "BENEFIT_PLAN", "BENEFIT_ACTUAL",
    # History and bookkeeping tables, which are not findings.
    "DP_CANDIDATE_STATUS_HISTORY", "DP_CANDIDATE_PAYLOAD_HISTORY",
    "KPI_CANONICAL_HISTORY", "GOVERNANCE_SEED", "RUN_DELTA", "SCHEMA_VERSION",
    "ENGAGEMENT", "DECISION_REGISTER", "ASSUMPTION_REGISTER", "VALUE_ASSUMPTION",
)
